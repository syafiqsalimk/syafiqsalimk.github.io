     ...
     <form action="" id="deleteForm" method="post">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 {{ csrf_field() }}
                 {{ method_field('DELETE') }}
                 <p class="text-center">Apakah anda yakin untuk menghapus Data anak? Data yang sudah dihapus tidak bisa kembali</p>
             </div>
...
<!--End Modal-->
    ...
    <div class="card shadow mb-4">
                ...
                <a href="#PilihPasien" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="PilihPasien">
                  <h6 class="m-0 font-weight-bold text-primary">Data Anak</h6></a>
